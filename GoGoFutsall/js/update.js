...
let hit2 = new Audio();
let masuk = new Audio();
let peluit = new Audio();


hit.src = "suara/hit1.mp3";
hit2.src = "suara/hit2.mp3";
masuk.src = "suara/Goalll.mp3";
peluit.src = "suara/whistle.mp3";
